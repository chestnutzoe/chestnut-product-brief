...
独立 Skill：`chestnut-product-brief`。本仓库可以单独下载、提 Issue、点 Star。

- [读取 Skill](SKILL.md)
- [下载完整 Skill ZIP](https://github.com/chestnutzoe/chestnut-product-brief/releases/latest/download/chestnut-product-brief.zip)
- [全部 Chestnut Skills 与整包下载](https://github.com/chestnutzoe/chestnut-skills)

把 Skill 链接交给能读取 GitHub 的 AI，并说明要完成什么；需要安装时，下载完整 ZIP，解压后把 `chestnut-product-brief` 文件夹放入所用工具的 skills 目录，保留参考资料与脚本。
